...
################################################################################
base_out_dir <- file.path(in_dir, "modelling_script", "09_stability_analysis")

train_full <- readRDS(file.path(in_dir, "split_imputed_data", "ukb_G1_train_imputed.rds"))
test_full  <- readRDS(file.path(in_dir, "split_imputed_data", "ukb_G1_test_imputed.rds"))
